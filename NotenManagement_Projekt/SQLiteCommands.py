...
AlleFaecher = """SELECT Fach,Round(AVG(Noten), 2) AS "Durchschnitt", Zielnote,(Round(((SELECT COUNT(Noten)+1)*Zielnote)-(SELECT SUM(Noten)), 2)) AS "Sollnote" FROM Semester NATURAL JOIN Fach_Zielnote WHERE Fach LIKE "fach""""
